...
#####  Security settings for EC2-RDS connection

-  EC2 with docker has security group `docker-security-group`
-  RDS has `mysql-vpc-security-group`
-  to enable app in docker to connect to RDS
    -  go to `mysql-vpc-security-group`
    -  add rule
        -  port 3306
